...
var uiController = (function () {
  ...
  return {
    ...
    displayPercentages: function (allPercentages) {
      //zurlagiin NodeList iig oloh Node gdg ni dom iin neg tagiig heldeg jishee ni <button id="">click me </button>
      var elements = document.querySelectorAll(
        DOMstrings.expensePercentageLabel
      );
      // elements blgonii huvid zarlagiin huviig massive aas avj shivj oruulah
...
var appController = (function (uiController, financeController) {
  var ctrlAddItem = function () {
    ...
    if (input.description !== "" && input.value !== "") {
      ...
      //tusviig shineer tootsoolood uzuulne
      updateTusuv();
    }
  };
